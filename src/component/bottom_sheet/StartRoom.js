...
export default function StartRoom  (props) {
    ...
    return (
       ...
       <div className={style.switch_Line}></div>
        <div className={style.stratroomdivright}>
       ...
       ?"with people I follow" :"open to everyone"}</span></p>
       <div className="text-center">
        <button className={style.letGoBtn} 
        onClick={()=>{props.setSheetCreateRoom(true) ;props.setSheetVisible(true)}}> 🎉Lets go</button>
       </div>
       </>
    )
}
